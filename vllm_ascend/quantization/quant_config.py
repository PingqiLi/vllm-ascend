    ...
    def get_quant_method(self, layer: torch.nn.Module,
        ...
        if self.quant_description.get("model_quant_type") == "RESQ":
            if isinstance(layer, LinearBase):
                return AscendLinearMethod(self, prefix, packed_modules_mapping={})
            return None
...
class AscendLinearMethod(LinearMethodBase):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        # This is needed for methods like ResQ that handle their own complex parameter registration.
        # We pass self as the wrapper if needed, but usually just forwarding args is enough.
